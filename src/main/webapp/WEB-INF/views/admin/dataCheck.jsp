...
<body>
			...
			<div class="col-md-2">
				<div class="sidebar content-box" style="display: block;">
					<ul class="nav">
						...
						<li>
							<a href="/admin/uploadData">
								<i class="glyphicon glyphicon-record"></i> Data Update
							</a>
						</li>
						<li class="submenu current">
							<a href="#">
								<i class="glyphicon glyphicon-record"></i> Data Check
								<span class="caret pull-right"></span>
							</a>
							<!-- Sub menu -->
							<ul>
								<li><a href="/admin/dataCheck">data</a></li>
							</ul>
						</li>
					</ul>
				</div>
	...
	<link href="/resources/css/admin/dataTables.bootstrap.css" rel="stylesheet" media="screen">
	...
	<script src="/resources/js/admin/bootstrap/dataTables.bootstrap.js"></script>
	<script src="/resources/js/admin/custom.js"></script>
	<script src="/resources/js/admin/tables.js"></script>
</body>
</html>