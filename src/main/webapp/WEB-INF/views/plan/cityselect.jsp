				...
				$.ajax({
					...
					success:function(response){
						...
						for(var i=0; i<response.length; i++){
							sub2+="<div class=\"item\" data-no=\"0\" data=\"10635\" country-id="+response[i].country_id+" city-name="+response[i].name+" data-latitude="+response[i].latitude+" data-longitude="+response[i].longitude+">"
					        ...
					        +"<a data-toggle=\"modal\" data-target=\"#startPopup\" href=\" /startdate\"><img id=\"startPlan\" src=\"/resources/img/plan/startPlan.png\" style=\"width:30px;\"></a></div>"
					        +"<div class=\"clear\"></div>"
					        +"</div>"
						}
...
$(function(){
	$('#PlanStart').click(function(){
		...
		$.ajax({
			type:'POST',
			url:'/dddddd',
			data:{"startDate" : startDate ,"endDate":endDate,"tourTitle":"test"},
			success:function(){
	...
	<div class="header">
		<div class="wrap" style="width: 100%; padding: 0px 10px;">
			...
			<div class="fr gnb_box">
				...
				<!-- <a href="/ko/plan"> -->
					<div class="fr gnb_plan_create_close_btn" id="close22" data-toggle="modal" data-target="#myModal">닫기</div>
				<!-- </a> -->      
				<div class="clear"></div>
			</div>
		</div>
...
<sciprt src="resources/js/index.js"></sciprt>
<!-- </div> -->
