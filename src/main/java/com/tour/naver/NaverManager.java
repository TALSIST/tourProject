...
public class NaverManager {
	public void naverBlogData(String title) {
        ...
        try {
            ...
            br.close();
            FileWriter fw = new FileWriter("/home/sist/tour_data/music_reply.xml");
    ...
    public void naverXmlParse(){
    	try {
			File file = new File("/home/sist/tour_data/music_reply.xml");
			...
			FileWriter fw = new FileWriter("/home/sist/tour_data/naver.txt");
			fw.write(data);
			fw.close();
		} catch (Exception e) {
			e.printStackTrace();
